...
class SimpleCurrencyAgent:
    ...
    def _respond_irrelevant(self, state: CurrencyState) -> CurrencyState:
        ...
        response_content = exchange_data.get(
    ...
    def _create_graph(self):
        ...
        workflow.add_conditional_edges(
            ...
            {"get_rate": "get_rate", "respond_irrelevant": "respond_irrelevant"},
        )
    ...
    def _should_get_rate(self, state: CurrencyState) -> str:
        ...
        return (
            "get_rate"
            if exchange_data.get("is_currency_query", False)
            else "respond_irrelevant"
        )
